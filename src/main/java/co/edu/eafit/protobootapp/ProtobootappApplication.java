...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y nos permite aprender sobre CI y CD.%n Estudiante: Antoine Chavane");
    }    
